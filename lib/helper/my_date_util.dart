...
class MyDateUtil{
  ...
  static String getLastMessageTime({required BuildContext context, required String time, bool showYear=false}){
    ...
    print("enjsn");
    print(sent.year);
    print('${sent.day} ${_getMonth(sent)} ${sent.year}');
  ...
  getLastActiveTime({required BuildContext context,required String lastActive}){
...
static String getMessageTime({required BuildContext context, required String time}){
    ...
    String d="$formattedTime - ${sent.day} ${_getMonth(sent)}";
    String r="$formattedTime - ${sent.day} ${_getMonth(sent) } ${sent.year}";
    return now.year==sent.year?d:r;
